    ...
    public class BaseGeneratorBuild extends StructuralBatteryBuild{
        ...
        public void update(){
          ...
          if(c!=null){
            ...
            if(c.start&&power.status*capacity+increasePower*c.efficiency<=capacity){
            power.status+=increasePower*c.efficiency;
            //防止卡在电力上限附近
        ...
        public void outputPower(){
            ...
            float output = powerOutput / battery.size()*c.efficiency;
